...
def refresh_essence(
    ...
    state_obj: bodies.BodyEssence = get_state(body, extra_fields=extra_fields)
    state_str: str = json.dumps(state_obj)
    patch.setdefault('metadata', {}).setdefault('annotations', {})[LAST_SEEN_ANNOTATION] = state_str
